...
if temps[0] > temps[1] <= temps[2]:
    ...
    print(":(")
elif temps[0] < temps[1] and temps[1] - temps[0] > temps[2] - temps[1]:
    print(":(")
elif temps[0] < temps[1] and temps[1] - temps[0] <= temps[2] - temps[1]:
    print(":)")
elif temps[0] > temps[1] > temps[2] and temps[0] - temps[1] > temps[1] - temps[2]:
    print(":)")
elif temps[0] > temps[1] > temps[2] and temps[1] - temps[0] <= temps[2] - temps[1]:
    print(":(")
elif temps[0] == temps[1] and temps[2] > temps[1]:
    print(":)")
else:
    print(":(")